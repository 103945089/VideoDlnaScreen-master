...
public class MediaPlayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        contentUrlView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("fhp",contentUrlView.getText().toString());
            }
        });
    ...
    private void set() {
        if (!etUrl.getText().toString().isEmpty()){
            RemoteItem itemurl1 = new RemoteItem("我的选择", "425703", "Fhp",
                    107362668, "00:04:33", "1280x720", etUrl.getText().toString());
